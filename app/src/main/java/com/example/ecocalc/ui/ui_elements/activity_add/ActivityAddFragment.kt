package com.example.ecocalc.ui.ui_elements.activity_add
...
import com.example.ecocalc.ui.ui_elements.added_activities.AddedActivitiesDialog
import com.example.ecocalc.ui.ui_elements.activity_add.meal.MealDialog
import com.example.ecocalc.ui.state_holders.activity_add.MealDialogViewModel
import com.example.ecocalc.ui.ui_elements.activity_add.plastic.PlasticDialog
import com.example.ecocalc.ui.state_holders.activity_add.PlasticDialogViewModel
import com.example.ecocalc.ui.ui_elements.activity_add.transport.TransportDialog
    ...
    override fun onCreateView(
        ...
        binding.transportButton.apply {
            setOnClickListener(View.OnClickListener { view ->
                val dialog = TransportDialog(TransportDialogViewModel(userDao))
        ...
        binding.mealButton.apply {
            setOnClickListener(View.OnClickListener { view ->
                val dialog = MealDialog(MealDialogViewModel(userDao))
        ...
        binding.plasticButton.apply {
            setOnClickListener(View.OnClickListener { view ->
                val dialog = PlasticDialog(PlasticDialogViewModel(userDao))
        ...
        binding.mealAddedButton.apply {
            setOnClickListener(View.OnClickListener { view ->
                val dialog = AddedActivitiesDialog("MEAL", AddedActivitiesDialogViewModel())
        ...
        binding.transportAddedButton.apply {
            setOnClickListener(View.OnClickListener { view ->
                val dialog = AddedActivitiesDialog("TRANSPORT", AddedActivitiesDialogViewModel())
        ...
        binding.plasticAddedButton.apply {
            setOnClickListener(View.OnClickListener { view ->
                val dialog = AddedActivitiesDialog("PLASTIC", AddedActivitiesDialogViewModel())
